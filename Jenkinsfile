peline {
    ...
    parameters {
         string(name: 'tomcat_dev', defaultValue: '54.234.131.80', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '54.205.17.82', description: 'Production Server')
    }
